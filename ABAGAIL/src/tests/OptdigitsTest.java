...
public class OptdigitsTest {
    ...
    private static final Double DEFAULT_INIT_TEMP = Math.pow(10, 2);
    private static final Double DEFAULT_COOLING_FACTOR = 0.5;

    // Change these for Genetic Algorithms
    private static final int INITIAL_POPULATION = 250;
    ...
    public static void main(String[] args) throws IOException {
        ...
        String path = "src/tests/data/titanic.arff"; // Path to data file. Change if necessary
