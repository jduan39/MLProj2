...
public class MyTravelingSalesmanTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int iter = 0; iter < 1000; iter++) {
            ...
            rhc_f.write(iter + ", " + ef.value(rhc.getOptimal()) + ", " + time/Math.pow(10, 9) + "\n");
            rhc_f.flush();
            ...
            sa_f.write(iter + ", " + ef.value(sa.getOptimal()) + ", " + time/Math.pow(10, 9) + "\n");
            sa_f.flush();
            ...
            time = System.nanoTime() - start;
            ga_f.write(iter + ", " + ef.value(ga.getOptimal()) + ", "  + time/Math.pow(10, 9) + "\n");
            ga_f.flush();
            ...
            time = System.nanoTime() - start;
            mimic_f.write(iter + ", " + ef.value(mimic.getOptimal()) + ", " + time/Math.pow(10, 9) + "\n");
            mimic_f.flush();
        }
        rhc_f.close();
        sa_f.close();
